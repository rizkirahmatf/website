                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="breadcome-list">
                                <ul class="breadcome-menu">
                                    ...
                                    <li><span class="bread-blod">Tambah Peminjaman</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                            ...
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input name="id" type="text" class="form-control" placeholder="Alat">
                                                                </div>
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            $no=1;
                                                            $sql = "SELECT cart.id_cart, cart.id_stock, stock.alat FROM cart, stock WHERE cart.id_cart=stock.id";
                                                            $query = mysqli_query($conn, $sql);
                    
                                                            while($pinjam = mysqli_fetch_array($query)){
                                                            echo "<tr>";
                                                                echo "<td>".$no++."</td>";
                                                                echo "<td>".$pinjam['id_stock']."</td>";
                                                                echo "<td>".$pinjam['alat']."</td>";
                                                        ?>
                                                    
                                                            <td>
                                                                <div class="form-button-action">
                                                                    <?php 
                                                                        echo "<a href='proses-hapus-peminjaman.php?id_cart=".$pinjam['id_cart']."' onclick=\"return confirm('Yakin Hapus Data Alat')\">";
                                                                    ?>
                                                ...
                                                <?php if (mysqli_num_rows($query) == 0) {
                                                    echo "Tidak ada buku ditambahkan.";
                                                }else{ ?>
                                                <form action="proses-tambah-pinjam.php" method="POST">
                                                    <input type="submit" class="btn btn-success" value="Submit" name="submit"></input></form><?php } ;?>
                                                </form>
                                                            </div>
                                                        </div>
                                                    </form>
