                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="breadcome-list">
                                <ul class="breadcome-menu">
                                    ...
                                    <li><a href="alat.php">Data Peminjaman Alat</a> <span class="bread-slash">/</span>
                                    </li>
                                    <li><span class="bread-blod">Tambah Peminjaman Alat</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                                    ...
                                                    <form action="">
                                                        <div class="row">
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                ...
                                                                <div class="form-group">
                                                                    <input name="alat" type="text" class="form-control" placeholder="Alat">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input name="nama" type="text" class="form-control" placeholder="Jumlah">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input name="tanggal_peminjaman" id="finish" type="text" class="form-control" placeholder="Tanggal Peminjaman">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input name="batas_tanggal" id="finish" type="text" class="form-control" placeholder="Batas Peminjaman">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
